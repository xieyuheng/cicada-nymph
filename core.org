...
** use hash-table to organize file-descriptor
...
** hi
   ...
   : hi,say
     ...
     dup 0 equal? if drop "* me wile moku e pona muko ^-^" .s end then
     dup 1 equal? if drop "* cica cica da yaya !!!" .s end then
     dup 2 equal? if drop "* hi ^-^" .s end then
     dup 3 equal? if drop "* hello :)" .s end then
     dup 4 equal? if drop "* hey *^-^*" .s end then
     dup 5 equal? if drop "* hiya \^o^/" .s end then
     dup 6 equal? if drop "* I wish you a lovely day" .s end then
     dup 7 equal? if drop "* I wish you a lovely day { or night :P }" .s end then
     dup 8 equal? if drop "* o.o" .s end then
