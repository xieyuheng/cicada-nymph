...
** dup  [32bit]
   ...
   define_primitive_function "dup", dup
      ;; << a -- a a >>
      mov  eax, [pointer$argument_stack - (1 * jo_size)]
      push_argument_stack eax
      next

   define_primitive_function "dup2", dup2
      ;; << a b -- a b a b >>
      mov  ebx, [pointer$argument_stack - (1 * jo_size)]
      mov  eax, [pointer$argument_stack - (2 * jo_size)]
      push_argument_stack eax
...
** over [32bit]
   ...
   define_primitive_function "x|over|xx", xoverxx
      ;; << a | b c -- a | b c | a >>
      mov  eax, [pointer$argument_stack - (3 * jo_size)]
      push_argument_stack eax
      next
   ...
   define_primitive_function "xx|over|xx", xxoverxx
      ;; << a b | c d -- a b | c d | a b >>
      mov  eax, [pointer$argument_stack - (4 * jo_size)]
      push_argument_stack eax
      mov  eax, [pointer$argument_stack - (4 * jo_size)]
      push_argument_stack eax
      next
   ...
   define_primitive_function "xx|over|xxxx", xxoverxxxx
      ...
      mov  eax, [pointer$argument_stack - (6 * jo_size)]
      push_argument_stack eax
      mov  eax, [pointer$argument_stack - (6 * jo_size)]
      push_argument_stack eax
      next
