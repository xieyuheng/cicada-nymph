...
** init-syscall-number
   ...
   0 : :syscall-number,link:       ; define-variable
   0 : :syscall-number,unlink:     ; define-variable
   0 : :syscall-number,mkdir:      ; define-variable
   0 : :syscall-number,rmdir:      ; define-variable
   0 : :syscall-number,getdents:   ; define-variable
   0 : :syscall-number,getdents64: ; define-variable
   ...
   : init-syscall-number
     ...
     *jo-size* 4 equal? if
       ...
       9   address :syscall-number,link:       save
       10  address :syscall-number,unlink:     save
       39  address :syscall-number,mkdir:      save
       40  address :syscall-number,rmdir:      save
       141 address :syscall-number,getdents:   save
       220 address :syscall-number,getdents64: save
     ...
     *jo-size* 8 equal? if
       ...
       86  address :syscall-number,link:       save
       87  address :syscall-number,unlink:     save
       83  address :syscall-number,mkdir:      save
       84  address :syscall-number,rmdir:      save
       78  address :syscall-number,getdents:   save
       217 address :syscall-number,getdents64: save
...
** error-code->string
   ...
   #+end_src
* report
** list-dictionary,by-jo-predicate
   * 最後寫到珠典裏的 被最先打印出來
   #+begin_src cicada-nymph :tangle core.cn
   : list-dictionary,by-jo-predicate,loop
...
** test
   #+begin_src cicada-nymph
   : test,list-dictionary,by-jo-predicate
     << -- >>
     jo primitive-function-jo? list-dictionary,by-jo-predicate
     end
   ; define-function
   test,list-dictionary,by-jo-predicate
   #+end_src
** report-dictionary
   * different types of words in dictionary
   ...
   : report-dictionary
     ...
     jo function-jo?
     list-dictionary,by-jo-predicate add
...
** test
   ...
   : cn ; path-to-directory? . << 0 >>
   : core ; path-to-directory? . << 1 >>
   : ai ; path-to-directory? . << 0 >>
   #+end_src
* file-tree
** note interface
   * file-tree
...
** creat-file
   ...
   : creat-file
     ...
     dup
     negative? if
       "* (creat-file) fail to open port for the following path :" .s .l
       "  " .s ::path .s .l
     ...
     then
     "* (creat-file) fail to close port for the following path :" .s .l
     "  " .s ::path .s .l
     "  " .s error-code->string .s .l
     end
   ; define-function
...
** update-file
   ...
   : update-file
     ...
     dup
     negative? if
       "* (update-file) fail to open port for the following path :" .s .l
       "  " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
     ...
     dup
     negative? if
       "* (update-file) fail to write port for the following path :" .s .l
       "  " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
     ...
     then
     "* (update-file) fail to close port for the following path : " .s .l
     "  " .s ::path .s .l
     "  " .s error-code->string .s .l
     end
   ; define-function
...
** remove-file
   ...
   : remove-file
     ...
     dup
     negative? if
       "* (remove-file) fail for the following path :" .s .l
       "  " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
...
** test
   ...
   : test,update-file
     << -- >>
     "kkk~" creat-file
     "kkk took my baby away !!!" "kkk~" update-file
     end
   ; define-function
   test,update-file
...
** creat-directory
   ...
   : creat-directory
     ...
     dup
     negative? if
       "* (creat-directory) fail for the following path :" .s .l
       "  " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
...
** remove-directory
   ...
   : remove-directory
     ...
     dup
     negative? if
       "* (remove-directory) fail for the following path :" .s .l
       "  " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
...
** test
   #+begin_src cicada-nymph
   : test,creat-directory
     << -- >>
     "play" creat-directory
     end
   ; define-function
   test,creat-directory
...
** test
   ...
   : test,getdents64,print
     ...
     "+getdents64,d_type+ : "   .s +getdents64,d_type+    fetch-byte . .l
     "+getdents64,d_name+ : "   .s
     +getdents64,d_name+
     dup 256 0 find-char,string
     drop  << drop 0 >>
     over sub
     .s .l
     .l  
