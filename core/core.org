...
** test
   ...
   : test,remove-char!
     ...
     "2#1001_1001"
     "_" string-head,char
     remove-char! write-string << 2#1001_1001 >>
     cr
     "___2#1001___1001___"
     "_" string-head,char
     remove-char! write-string << 2#1001_1001 >>
...
** latin-char->number
   ...
   : latin-char->number
     ...
     dup "A" string-head,char less-than? if
       "* (latin-char->number) the argument must be a latin-char" .s
       "  but the following char is less-than 'A' : " write-string
       write-integer cr
       end
     then
     ...
     dup "a" string-head,char less-than? if
       "* (latin-char->number) the argument must be a latin-char" .s
       "  but the following char is less-than 'a' but greater-then 'Z' : " write-string
       write-integer cr
       end
     then
     dup "z" string-head,char less-or-equal? if
     ...
     then
     "* (latin-char->number) the argument must be a latin-char" .s
     "  but the following char is greater-then 'z' : " write-string
     write-integer cr
     end
   ; define-function
   #+end_src
...
** base#wild-integer-string->base-string
   ...
   : base#wild-integer-string->base-string
     ...
     find-char,string if
       ...
       "* (base#wild-integer-string->base-string)" .s
       "  the argument must be a base#wild-integer-string" .s
       "  but the following string does not even have a '#' in it :" .s
       "  " write-string
       :address :length .s
...
** base#wild-integer-string->wild-integer-string
   ...
   : base#wild-integer-string->wild-integer-string
     ...
     find-char,string if
       ...
       "* (base#wild-integer-string->wild-integer-string)" .s
       "  the argument must be a base#wild-integer-string" .s
       "  but the following string does not even have a '#' in it :" .s
       "  " write-string
       :address :length .s
...
** test
   ...
   : test,base#wild-integer-string->base-string
     ...
     cr
     "1#1" base#wild-integer-string->base-string .s << 1 >>
     "123#1c29bf219g42" base#wild-integer-string->base-string .s << 123 >>
     "___2___#__1___c29bf210019___g42" base#wild-integer-string->base-string .s << ___2___ >>
     cr
     end
   ; define-function
   test,base#wild-integer-string->base-string
   ...
   : test,base#wild-integer-string->wild-integer-string
     ...
     cr
     "1#1" base#wild-integer-string->wild-integer-string .s << 1 >>
     "123#1c29bf219g42" base#wild-integer-string->wild-integer-string .s << 1c29bf219g42 >>
     "___2___#__1___c29bf210019___g42" base#wild-integer-string->wild-integer-string .s << __1___c29bf210019___g42 >>
     cr
     end
   ; define-function
   test,base#wild-integer-string->wild-integer-string
...
** error-code->string
   ...
   : error-code->string
     ...
     "unknow error-code : " write-string
     write-integer cr
     end
   ; define-function
   #+end_src
...
** report-syntax
   ...
   : report-syntax
     << -- >>
     "* *rule-set,make-jojo* :" .s
      *rule-set,make-jojo* list-rule
     "* *rule-set,basic-REPL* :" .s
...
** initial-report
   ...
   : initial-report
     ...
     "  " write-string report-loaded-core-file
...
** help
   ...
   : help
     << -- >>
     "* helpful documentations will be written soon" .s
     "  please wait ^-^" .s
     end
   ; define-function
   #+end_src
...
** test
   ...
   : test,stat
     ...
     +stat,st_dev+        fetch . "+stat,st_dev+" .s
     +stat,st_ino+        fetch . "+stat,st_ino+" .s
     *jo-size* 4 equal? if
     +stat,st_mode+       fetch-two-bytes  . "+stat,st_mode+" .s
     +stat,st_nlink+      fetch-two-bytes  . "+stat,st_nlink+" .s
     +stat,st_uid+        fetch-two-bytes  . "+stat,st_uid+" .s
     +stat,st_gid+        fetch-two-bytes  . "+stat,st_gid+" .s
     then
     *jo-size* 8 equal? if
     +stat,st_nlink+      fetch  . "+stat,st_nlink+" .s
     +stat,st_mode+       fetch-four-bytes  . "+stat,st_mode+" .s
     +stat,st_uid+        fetch-four-bytes  . "+stat,st_uid+" .s
     +stat,st_gid+        fetch-four-bytes  . "+stat,st_gid+" .s
     then
     +stat,st_rdev+       fetch . "+stat,st_rdev+" .s
     +stat,st_size+       fetch . "+stat,st_size+" .s
     +stat,st_blksize+    fetch . "+stat,st_blksize+" .s
     +stat,st_blocks+     fetch . "+stat,st_blocks+" .s
     +stat,st_atime+      fetch . "+stat,st_atime+" .s
     +stat,st_atime_nsec+ fetch . "+stat,st_atime_nsec+" .s
     +stat,st_mtime+      fetch . "+stat,st_mtime+" .s
     +stat,st_mtime_nsec+ fetch . "+stat,st_mtime_nsec+" .s
     +stat,st_ctime+      fetch . "+stat,st_ctime+" .s
     +stat,st_ctime_nsec+ fetch . "+stat,st_ctime_nsec+" .s
     +stat,__unused4+     fetch . "+stat,__unused4+" .s
     +stat,__unused5+     fetch . "+stat,__unused5+" .s
     end
   ; define-function
