   ...
   : define-function,with-title
     ...
     *link,core* xx|swap|x
     ...
     ::title name-hash-table,find-jo not if
       ::title make-title
       ::title name-hash-table,find-jo drop
     then
     *jo-size* add >:title-as-link
     :title-as-link fetch >:first-jo
