...
** *rule-set,word-interpreter*
   ...
   *rule-set,word-interpreter*
   *rule-set,word-interpreter* *cell-size* sub
   set
   #+end_src
** word-interpreter
   #+begin_src cicada-nymph :tangle core.cn
...
*** <undo-point> restore-syntax-backup-area,set-syntax
    ...
    : <undo-point> restore-syntax-backup-area,set-syntax
      ...
      :rule-set-copy *cell-size* add get >:n

      :rule-set :cursor set

      :rule-set-copy *cell-size* 2 mul add
      :n n-get
      :rule-set
      :n n-set
      ...
      *cell-size*
      ...
      :rule-set-copy *cell-size* :n 2 add mul add
...
* <pre-module> *rule-set*
  ...
  *cell-size* allocate-memory drop
  ...
  <pre-module> *rule-set*
  <pre-module> *rule-set* *cell-size* sub
  set
  #+end_src
* <post-module> *rule-set*
  ...
  *cell-size* allocate-memory drop
  ...
  <post-module> *rule-set*
  <post-module> *rule-set* *cell-size* sub
  set
  #+end_src
* <module-buffer>
