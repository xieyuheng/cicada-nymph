...
* <string> eval
** note
   * (<string> eval) is implemented by doing side-effect on reading-stack
     this is because syntax extension system is implemented by reader-macro
   * by implementing (<string> eval) this way
...
** test
   #+begin_src cicada-nymph
   "1 2 3 add add . " <string> eval << 6 >>
   "1 2 3 add add ." <string> eval  << 6 >>
   ": k 1 2 3 add add . end ; define-function k" <string> eval << 6 >>
   k << 6 >>
   #+end_src
* define-variable
...
** >< import
   ...
   : import
     ...
     >::module-name
     ::module-name <module> find if
     else
       end
     then
     >::module-path

     32 1024 mul allocate-local-memory >:buffer
     ...
     :buffer :counter
     <module> get-meta >::meta

     :buffer :counter
     <module> get-code >::code

     ><><>< global-naming-stack >:pointer,global-naming-stack
     ...
     ><><>< move global-naming-stack

     ><><>< clear global-naming-stack
