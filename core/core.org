...
*** 使用匿名函數
*** 使用返回值
** 在 不知有 name-hash-table 之前所設計的很多東西 需要改進
...
** more,rule-set,make-jojo
   ...
   : more,rule-set,make-jojo
     << -- >>
     *rule-set,make-jojo*
     dup jo word:if?    jo make-jojo-syntax,if    rule,add
     dup jo word:else?  jo make-jojo-syntax,else  rule,add
     dup jo word:then?  jo make-jojo-syntax,then  rule,add
     dup jo word:loop?  jo make-jojo-syntax,loop  rule,add
         jo word:recur? jo make-jojo-syntax,recur rule,add
     end
   ; define-function
   more,rule-set,make-jojo
   #+end_src
...
** test REPL
   ...
   #+end_src
* make-jojo
** make-jojo,dispatch-word            :redefine:
   #+begin_src cicada-nymph :tangle core.cn
   : make-jojo,dispatch-word
     ...
     global-naming-stack,delete-last-record
     'make-jojo,dispatch-word,fail awake
   ; define-function
   #+end_src
** make-jojo,dispatch-word,fail
   #+begin_src cicada-nymph :tangle core.cn
   : make-jojo,dispatch-word,fail
     "* (make-jojo,dispatch-word,fail)" .s .l
     drop-syntax-stack
     action,reset-the-stack
     << scope-stack-pointer -- >>
...
** make-jojo                          :redefine:
   ...
   : make-jojo
     ...
     *scope-stack,unit* address *scope-stack,pointer* add-set
     ...
     jo make-jojo,dispatch-word,fail
     'make-jojo,dispatch-word,fail await

     *rule-set,make-jojo* push-syntax-stack
     :jo ::string make-jojo,loop
     drop-syntax-stack
...
** make-jojo-syntax,local-variable-get :redefine:
   #+begin_src cicada-nymph :tangle core.cn
   : make-jojo-syntax,local-variable-get
     ...
     then
     "* (make-jojo-syntax,local-variable-get)" .s .l
     "  local-variable not bound : " .s
        .s .l
     'undo-make-jojo await
   ; define-function
   #+end_src
** make-jojo-syntax,local-variable-set :redefine:
   #+begin_src cicada-nymph :tangle core.cn
...
** make-jojo-syntax,if                :redefine:
   ...
   ; define-function
   #+end_src
** make-jojo-syntax,else              :redefine:
   #+begin_src cicada-nymph :tangle core.cn
   : make-jojo-syntax,else
     << scope-stack-pointer,
        address,
   ...
   ; define-function
   #+end_src
** make-jojo-syntax,then              :redefine:
   #+begin_src cicada-nymph :tangle core.cn
   : make-jojo-syntax,then
     << scope-stack-pointer,
        address,
...
** more,rule-set,make-jojo
   ...
   : more,rule-set,make-jojo
     ...
     *rule-set,make-jojo*
     ...
     jo make-jojo-syntax,local-variable-get
     rule,add
     *rule-set,make-jojo*
     jo local-variable-set-word?
     jo make-jojo-syntax,local-variable-set
     rule,add
     *rule-set,make-jojo*
     dup jo word:if?    jo make-jojo-syntax,if    rule,add
     dup jo word:else?  jo make-jojo-syntax,else  rule,add
         jo word:then?  jo make-jojo-syntax,then  rule,add
     end
   ; define-function
   more,rule-set,make-jojo
   #+end_src
...
** make-jojo-syntax,title
   ...
   : make-jojo-syntax,title
     ...
     name-hash-table,find-jo,with-title if
       ...
       "* (make-jojo-syntax,title) meet undefined" .s .l
       "  title : " .s ::title .s .l
...
** more,rule-set,make-jojo
   ...
   : more,rule-set,make-jojo
     << -- >>
     *rule-set,make-jojo*
     jo <word>? jo make-jojo-syntax,title rule,add
     end
   ; define-function
   more,rule-set,make-jojo
   #+end_src
...
** more,rule-set,make-jojo
   ...
   more,rule-set,make-jojo
   #+end_src
** test <make-jojo-syntax> name
   #+begin_src cicada-nymph :tangle core-test.cn
   : <make-jojo-syntax> name,test
     << -- string[address, length] >>
     name test-name name->string
     end
   ; test-function

   : "* (testing) <make-jojo-syntax> name" .s .l
     <make-jojo-syntax> name,test
...
*** <eval-word-syntax> jo
    ...
    : <eval-word-syntax> jo
      ...
      then
      "* (<eval-word-syntax> jo) meet undefined word after jo : " .s ::word .s .l
      end
    ; define-function
    #+end_src
*** more,rule-set,basic-REPL
    ...
    : more,rule-set,basic-REPL
      << -- >>
      *rule-set,eval-word*
      ["bye" string-equal? end] jo eval-word-syntax,bye
      rule,add

      *rule-set,eval-word*
      ["jo" string-equal? end] jo <eval-word-syntax> jo
      rule,add
      end
    ; define-function
    more,rule-set,basic-REPL
...
*** <eval-word-syntax> if,meet-true
    #+begin_src cicada-nymph :tangle core.cn
    : <eval-word-syntax> if,meet-true,else
      << -- >>
      read-word
    ...
    ; define-function
    #+end_src
*** <eval-word-syntax> if,meet-false
    #+begin_src cicada-nymph :tangle core.cn
    : <eval-word-syntax> if,meet-false,else
      << -- >>
      read-word
      dup2 "then" string-equal? if
        drop2
...
*** rule,add to *rule-set,eval-word*
    #+begin_src cicada-nymph :tangle core.cn
    *rule-set,eval-word*
    jo word:if? jo <eval-word-syntax> if
    rule,add
    #+end_src
*** test <eval-word-syntax> if & else & then
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <eval-word-syntax> if & else & then" .s .l
      1
      one? if
        111
      then
...
*** circular-string-area,stay
    ...
    ; define-function
    #+end_src
*** <eval-word-syntax> double-quote
    * in ASCII encode double-quote is 34
    #+begin_src cicada-nymph :tangle core.cn
    : <eval-word-syntax> double-quote,loop
      << cursor -- cursor >>
      read-byte
      dup 34 equal? if
        drop
...
*** rule,add to *rule-set,eval-word*
    #+begin_src cicada-nymph :tangle core.cn
    *rule-set,eval-word*
    jo word:double-quote? jo <eval-word-syntax> double-quote
    rule,add
    #+end_src
*** test <eval-word-syntax> double-quote
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <eval-word-syntax> double-quote" .s .l
      1
      one? if
        "111"
      then
...
*** <eval-word-syntax> address
    ...
    : <eval-word-syntax> address
      ...
      ::word name-hash-table,find-jo if
        ...
        "* (<eval-word-syntax> address) meet undefined word : " .s ::word .s .l
        end
      then
      ...
      :jo variable-jo? if
        ...
        "* (<eval-word-syntax> address) meet a not variable-jo : " .s ::word .s .l
        end
      then
      :jo *jo-size* add
      end
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    jo word:address?
    jo <eval-word-syntax> address
    rule,add
    #+end_src
*** test <eval-word-syntax> address
    #+begin_src cicada-nymph :tangle core-test.cn
    0
    : <eval-word-syntax> *testing-variable*
    ; test-variable,with-tos

    : "* (testing) <eval-word-syntax> address" .s .l
      666
      address <eval-word-syntax> *testing-variable* set
      <eval-word-syntax> *testing-variable*
      666 equal? test
    ; test-do
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    jo word:name?
    jo <eval-word-syntax> name
    rule,add
    #+end_src
*** test <eval-word-syntax> name
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <eval-word-syntax> name" .s .l
      name add
      name->string "add" <string> equal? test
      name <eval-word-syntax> *testing-variable*
      name->string "<eval-word-syntax> *testing-variable*" <string> equal? test
      name kkk
      name->string "kkk" <string> equal? test
    ; test-do
    #+end_src
** quote
*** <eval-word-syntax> quote
    #+begin_src cicada-nymph :tangle core.cn
    : <eval-word-syntax> quote
      << quote-word -- name >>
      string,byte-tail string->name
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    jo quote-word?
    jo <eval-word-syntax> quote
    rule,add
    #+end_src
*** test <eval-word-syntax> quote
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <eval-word-syntax> name" .s .l
      'add
      name->string "add" <string> equal? test
...
*** <eval-word-syntax> title
    ...
    : <eval-word-syntax> title
      ...
      then
      "* (<eval-word-syntax> title) meet undefined" .s .l
      "  title : " .s ::title .s .l
      "  name  : " .s ::name .s .l
      end
    ; define-function
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    jo <word>?
    jo <eval-word-syntax> title
    rule,add
    #+end_src
*** test <eval-word-syntax> title
    #+begin_src cicada-nymph :tangle core-test.cn
    : <test-title> test-name
      << -- >>
      "TEST"
    ...
    : "* (testing) <eval-word-syntax> title" .s .l
      <test-title> test-name
...
** test
   ...
   *rule-set,eval-word*
   ...
   jo <eval-word-syntax> double-quote
   rule,add
...
** syntax
   #+begin_src cicada-nymph :tangle core.cn
   "<make-jojo-syntax> title" "make-jojo-syntax,title" alias
   "<make-jojo-syntax> recur" "make-jojo-syntax,recur" alias
   "<make-jojo-syntax> loop" "make-jojo-syntax,loop" alias
   "<make-jojo-syntax> then" "make-jojo-syntax,then" alias
   "<make-jojo-syntax> else" "make-jojo-syntax,else" alias
   "<make-jojo-syntax> if" "make-jojo-syntax,if" alias
   "<make-jojo-syntax> local-variable-get" "make-jojo-syntax,local-variable-get" alias
   "<make-jojo-syntax> local-variable-set" "make-jojo-syntax,local-variable-set" alias
   "<make-jojo-syntax> double-quote" "syntax,double-quote,make-jojo" alias
   "<make-jojo-syntax> jo" "make-jojo-syntax,jo" alias
   "<make-jojo-syntax> address" "make-jojo-syntax,address" alias
   "<make-jojo-syntax> integer-string" "make-jojo-syntax,integer-string" alias

   "<eval-word-syntax> bye" "eval-word-syntax,bye" alias
   #+end_src
** <name-record>
   #+begin_src cicada-nymph :tangle core.cn
...
** test full-path?
   #+begin_src cicada-nymph :tangle core-test.cn
   : "* (testing) full-path?" .s .l
     "/home" relative-path? false?
     "/home" full-path?     true? and
     "home"  relative-path? true? and
     "home"  full-path?     false? and test
   ; test-do
   #+end_src
* poi
** 記
...
** <eval-word-syntax> path
   ...
   : <eval-word-syntax> path
     ...
     [ << word -- >>
       "* (<eval-word-syntax> path) the following word is of bad syntax : " .s .l
       "    " .s .s .l
       action,reset-the-stack
       << -- >>
     ...
     512 allocate-local-memory >:buffer
     :buffer <eval-word-syntax> path,loop >:cursor
...
** <moi> help
   ...
   : <moi> help
     << -- >>
     "* (<moi> help)" .s .l
     "  * cn moi add  <new-name> <relative-path-to-existing-directory>" .s .l
     "  * cn moi sub  <old-name>" .s .l
     "  * cn moi up   <old-name> <relative-path-to-existing-directory>" .s .l
     "  * cn moi find <old-name>" .s .l
     "  * cn moi list" .s .l
     end
   ; define-function
   #+end_src
...
** <command-function> stack-REPL
   ...
   : <command-function> stack-REPL
     ...
     "* (cicada-nymph) " .s hi
     <report> system
     "* (stack-REPL) is where you are in" .s .l
...
** <command-function> basic-REPL
   ...
   : <command-function> basic-REPL
     ...
     "* (cicada-nymph) " .s hi
     <report> system
     "* (basic-REPL) is where you are in" .s .l
