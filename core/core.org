...
* syntax for fixnum in other base
  * in REPL and make-jojo rule-set
...
** more,rule-set,make-jojo
   ...
   : more,rule-set,make-jojo
     ...
     jo word:prepare-for? jo syntax,prepare-for,make-jojo *rule-set,make-jojo* add-rule
     end
   ; define-function
