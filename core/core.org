...
* fix and optimize local-name
** optimize local-name by new instruction
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    ...
    rule,add
    #+end_src
*** test <basic-REPL-syntax> if & else & then
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <basic-REPL-syntax> if & else & then" .s .l
      1
      one? if
        111
      then
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    ...
    rule,add
    #+end_src
*** test <basic-REPL-syntax> double-quote
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <basic-REPL-syntax> double-quote" .s .l
      1
      one? if
        "111"
      then
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    ...
    rule,add
    #+end_src
*** test <basic-REPL-syntax> address
    #+begin_src cicada-nymph :tangle core-test.cn
    0
    : <basic-REPL-syntax> *testing-variable*
    ; test-variable,with-tos

    : "* (testing) <basic-REPL-syntax> address" .s .l
      666
      address <basic-REPL-syntax> *testing-variable* set
      <basic-REPL-syntax> *testing-variable*
      666 equal? test
    ; test-do
...
*** rule,add to *rule-set,eval-word*
    ...
    *rule-set,eval-word*
    ...
    rule,add
    #+end_src
*** test <basic-REPL-syntax> name
    #+begin_src cicada-nymph :tangle core-test.cn
    : "* (testing) <basic-REPL-syntax> name" .s .l
      name add
      name->string "add" <string> equal? test
      name <basic-REPL-syntax> *testing-variable*
      name->string "<basic-REPL-syntax> *testing-variable*" <string> equal? test
      name kkk
...
*** test <basic-REPL-syntax> title
    ...
    : "* (testing) <basic-REPL-syntax> title" .s .l
      <test-title> test-name
