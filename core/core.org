...
** test
   ...
   : test,getdents64
     ...
     then
     "* (test,getdents64) fail to close : " .s .i .l
     "  path : " .s ::path .s .l
     "  " .s error-code->string .s .l
     end
   ; define-function
...
** empty-directory?
   ...
   : empty-directory?
     ...
     then
     "* (empty-directory?) fail to close : " .s .i .l
     "  path : " .s ::path .s .l
     "  " .s error-code->string .s .l
     false
     end
...
** directory,list-file
   ...
   : directory,list-file,loop,structure
     << end, cursor -- >>
     dup2 less-or-equal? if
       drop2
       end
   ...
   : directory,list-file
     ...
     ::path input-port,open if
       ...
       "* (directory,list-file) fail to open : " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
     >:port
     :port directory,list-file,loop
     :port port,close if
       end
     then
     "* (directory,list-file) fail to close : " .s .i .l
     "  path : " .s ::path .s .l
     "  " .s error-code->string .s .l
     end
   ; define-function
...
** directory,list-directory
   #+begin_src cicada-nymph :tangle core.cn
   : directory,list-directory,print
     << -- >>
     +getdents64,d_type+ fetch-byte
     4 equal? not if
       end
   ...
   : directory,list-directory,loop,structure
     << end, cursor -- >>
     dup2 less-or-equal? if
       drop2
       end
   ...
   : directory,list-directory
     ...
     ::path input-port,open if
       ...
       "* (directory,list-directory) fail to open : " .s ::path .s .l
       "  " .s error-code->string .s .l
       end
     then
     >:port
     :port directory,list-directory,loop
     :port port,close if
       end
     then
     "* (directory,list-directory) fail to close : " .s .i .l
     "  path : " .s ::path .s .l
     "  " .s error-code->string .s .l
     end
   ; define-function
...
** >< directory,find-file
   #+begin_src cicada-nymph :tangle core.cn
   : directory,find-file
     << directory-path[address, length], file-path[address, length] -- >>
