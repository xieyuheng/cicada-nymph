...
** *backup-area*
   ...
   *backup-area,size* allocate-memory
   : *backup-area*
   ; define-variable,with-tos
...
*** backup-area
    ...
    : restore,backup-area
      ...
      *jo-size* 3 mul add fetch >:old-address
      :old-address *backup-area,current-free-address*
      restore,backup-area,save-jo
      :old-address address *backup-area,current-free-address* save
      end
    ; define-function
    #+end_src
** >< *undo-stack*
...
** undo
   ...
   : undo
     ...
     :undo-point restore,backup-area
     end
   ; define-function
   #+end_src
** test
   #+begin_src cicada-nymph
   4 *jo-size* mul allocate-memory
   : *undo-point*
   ; define-variable,with-tos
   ...
   *string-area,current-free-address*
   *undo-point* *jo-size* add save

   *link*
   *undo-point* *jo-size* add *jo-size* add save

   *backup-area,current-free-address*
   *undo-point* *jo-size* add  *jo-size* add *jo-size* add save
     ...
     *link* xx|swap|x
     ...
     :name-index name,used-as-jo? if
       ...
       *backup-area,current-free-address*
       2 n-save
       *jo-size* 2 mul
       address *backup-area,current-free-address*
       add-save
     then
     :link name-hash-table,save-jo,by-link
