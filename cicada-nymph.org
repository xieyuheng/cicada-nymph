...
** format [linux64]
   ...
   format ELF64 executable 3 as "cicada-nymph"
...
** format [linux32]
   ...
   format ELF executable 3 as "cicada-nymph-32"
...
** format [windows64]
   ...
   format PE64 console as "cicada-nymph.exe"
...
** format [windows32]
   ...
   format PE console as "cicada-nymph-32.exe"
...
** entry  [windows32]
   ...
   #+end_src
** macro  [windows32]
   * macro about windows32 calling-convention
   #+begin_src fasm :tangle cicada-nymph.fasm
   match =windows =32bit, platform machine {
...
** jo->type
   ...
   * other types of jo
   ...
   define_function "jo->type", jo_to_type
      ...
      xx dup, fetch
      xx swap, subtraction, literal, jo_to_type, equal?, false?branch, 4
      xx   drop, zero
      xx   end
...
** little_test
   ...
   define_function "little_test", little_test
      ...
      ;;;; address
      ;; xx address, V__little_test_number, fetch_two_bytes, add2
