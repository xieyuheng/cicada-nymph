...
** reading-stack-empty?
   * only one string is in reading-stack and it length is zero
   ...
   define_function "reading-stack-empty?", reading_stack_empty?
      ;; << -- bool >>
      xx literal, pointer$reading_stack, get
...
** digit-string?
   ...
   define_function "digit-string?", digit_string?
      ...
      xx   drop2, true
      xx   end
      xx over, get_byte, digit_char?, false?branch, 4
...
** find-rule
   ...
   define_function "find-rule", find_rule
      ...
      xx literal, cursor$find_rule, set
      xx find_rule__loop
      xx end
   ...
   define_function "find-rule,loop", find_rule__loop
      ...
      ;;    -- function, true
      ;;    -- false >>
      xx literal, cursor$find_rule, get
...
** syntax,comment,make-jojo
   * nested << >> must be handled
   ...
   define_function "syntax,comment,make-jojo", syntax__comment__make_jojo
      ...
      xx   end
      xx dup2
      xx string_tail__word, xxswapxx
      xx string_head__word
      xx dup2, comment_end_string?, false?branch, 3
      xx   drop2
      xx   end
      xx dup2, comment_begin_string?, false?branch, 3
...
* !undo-make-jojo
  ...
  define_exception "!undo-make-jojo", !undo_make_jojo
     ...
     xx address, V__jojo_area__current_free_address, set
     xx address, V__string_area__current_free_address
     xx set
     xx end
