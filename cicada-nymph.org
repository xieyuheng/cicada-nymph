...
** local-variable-table
   ...
   * 其中保存作爲 local-variable 名字的 字符串
     還有與這個 local-variable 所對應的 offset
   * 並且每次在定義一個新的函數體的時候
     這個 local-variable-table 會被初始話
* ===================================
* prolog
** ----------------------------------
...
** fetch & save [64bit]
   ...
   define_primitive_function "fetch-local-data", fetch_local_data
      ;; << offset -- value >>
      pop_argument_stack rcx
   ...
   define_primitive_function "save-local-data", save_local_data
      ;; << value, offset -- >>
      pop_argument_stack rcx
      pop_argument_stack rax
      mov rbx, [pointer$return_stack - (2 * jo_size)]
...
** 記 編譯的例子
   ...
   * 1 2 4 example . << 3 >>
     ...
     define_function "example", example
        ...
        ;; >:var2
        xx literal, jo_size, local_data_allocate__byte
        xx literal, 0, save_local_data
        ...
        ;; >:var1
        xx literal, jo_size, local_data_allocate__byte
        xx literal, (0 + jo_size), save_local_data

        ;; :var1
        xx literal, (0 + jo_size), fetch_local_data

        ;; :var2
        xx literal, 0, fetch_local_data
        ...
        xx literal, (0 + jo_size + 16), save_local_data
        ...
        ;; :address drop
        xx literal, (0 + jo_size + 16), fetch_local_data
        xx drop
        xx end
     #+end_src
** >< local-variable-fetch-string? & its macro
   #+begin_src fasm :tangle cicada-nymph.fasm
   ...
   define_macro "", M__local_variable_fetch_string?
      ...
      xx end
   #+end_src
** >< local-variable-save-string? & its macro
   #+begin_src fasm :tangle cicada-nymph.fasm
   ...
   define_macro "", M__local_variable_save_string?
      ...
      xx end
   #+end_src
** >< local-variable-save-address-string? & its macro
   #+begin_src fasm :tangle cicada-nymph.fasm
