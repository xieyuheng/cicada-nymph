...
** [maybe] implement all macro by dispatch-word-stack
...
** better error handling of load-file
...
** >< 局部變元
* note syscall
  * syscall is not expose to cicada-nymph
    they are wraped in assembly code
  * this is for to make cicada-nymph code more clean
  * but
    it would be much easier
    to wrap syscall in cicada-nymph code
    then to wrap them in assembly code
    so
    the costs are payed here
* ===================================
* prolog
** ----------------------------------
...
* file-tree io
** ----------------------------------
** file-tree,add                      :linux:64bit:
** file-tree,sub                      :linux:64bit:
** file-tree,find                     :linux:64bit:
** file-tree,list                     :linux:64bit:
** ----------------------------------
* path
** path-exist?
   #+begin_src fasm :tangle cicada-nymph.fasm
