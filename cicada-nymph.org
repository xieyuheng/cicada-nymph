...
* support about string in function
...
** !undo-define-function
   #+begin_src fasm :tangle cicada-nymph.fasm
   define_exception "!undo-define-function", !undo_define_function
      ;; << string[address, length]
      ;;    old V__current_free_address__primitive_string
      ;;    old V__current_free_address__jo_heap
      ;;    old V__first_jo_in_dictionary
      ;;    -- >>
      xx literal, string$undo_define_function_report
      xx literal, length$undo_define_function_report
      xx write_string
   ...
   string$undo_define_function_report:
      db "   (define-function) THE FOLLOWING WORD IS NOT DEFINED :"
      db 10
      db "     : "
   .end:
   length$undo_define_function_report = (.end - string$undo_define_function_report)
   #+end_src
** define-function
   #+begin_src fasm :tangle cicada-nymph.fasm
...
** !undo-define-macro
   #+begin_src fasm :tangle cicada-nymph.fasm
   define_exception "!undo-define-macro", !undo_define_macro
      ;; << string[address, length]
      ;;    old V__current_free_address__primitive_string
      ;;    old V__current_free_address__jo_heap
      ;;    old V__first_jo_in_dictionary
      ;;    -- >>
      xx literal, string$undo_define_macro_report
      xx literal, length$undo_define_macro_report
      xx write_string
   ...
   string$undo_define_macro_report:
      db "   (define-macro) THE FOLLOWING WORD IS NOT DEFINED :"
      db 10
      db "     : "
   .end:
   length$undo_define_macro_report = (.end - string$undo_define_macro_report)
   #+end_src
** define-macro
   #+begin_src fasm :tangle cicada-nymph.fasm
   ...
   #+end_src
** ----------------------------------
** !undo-define-exception
   #+begin_src fasm :tangle cicada-nymph.fasm
   define_exception "!undo-define-exception", !undo_define_exception
      ;; << string[address, length]
      ;;    old V__current_free_address__primitive_string
      ;;    old V__current_free_address__jo_heap
      ;;    old V__first_jo_in_dictionary
      ;;    -- >>
      xx literal, string$undo_define_exception_report
      xx literal, length$undo_define_exception_report
      xx write_string
   ...
   string$undo_define_exception_report:
      db "   (define-exception) THE FOLLOWING WORD IS NOT DEFINED :"
      db 10
      db "     : "
   .end:
   length$undo_define_exception_report = (.end - string$undo_define_exception_report)
   #+end_src
** define-exception
   #+begin_src fasm :tangle cicada-nymph.fasm
