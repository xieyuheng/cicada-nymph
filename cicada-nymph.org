...
** little_test
   ...
   define_function "little_test", little_test
      ...
      ;; xx read_word, string_to_integer ;; number
      ;; xx read_word, V__link__core, find_link ;; add
      ;; xx drop ;; true
      ;; xx link_to_jo
      ;; xx execute_jo
      ;; xx write_integer
...
** *link,core*
   * a link is the first jo in the link
   #+begin_src fasm :tangle cicada-nymph.fasm
   define_variable "*link,core*", V__link__core
...
** test
   ...
   : addadd ; string-head,word *link,core* find-link drop
   link->jo dup jo->length . << 3 >>
   1 2 3 x|swap|xxx execute-jo . << 6 >>
...
** the_last_link_in_assembly_code
   * this word helps to initialize V__link__core
   #+begin_src fasm :tangle cicada-nymph.fasm
