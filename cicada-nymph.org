...
** note many get & set
   ...
   * on stack
     << value-1, value-2, value-3, ... >>
** instructions,local-variable,[n-get|n-set] :64bit:
   #+begin_src fasm :tangle cicada-nymph.fasm
   match =64bit, machine {

   define_primitive_function "instructions,local-variable,n-get", instruction__local_variable__n_get
      ;; << -- value-1, ..., value-n >>
      pop_return_stack rbx
        mov rdx, [rbx]           ;; offset
   ...
   define_primitive_function "instructions,local-variable,n-set", instruction__local_variable__n_set
      ;; << value-n, ..., value-1 -- >>
      pop_return_stack rbx
        mov rdx, [rbx]           ;; offset
        mov rcx, [rbx + jo_size] ;; numebr
   ...
   #+end_src
** instructions,local-variable,[n-get|n-set] :32bit:
   #+begin_src fasm :tangle cicada-nymph.fasm
   match =32bit, machine {
