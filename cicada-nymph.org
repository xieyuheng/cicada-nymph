...
** ><>< *local-memory-x*
   #+begin_src fasm :tangle cicada-nymph.fasm
   size$local_memory_x = 1024 * 1024 * 6

   address$local_memory_x labeling
      preserve size$local_memory_x

   define_variable "*local-memory-x,current-free-address*", V__local_memory_x__current_free_address
      xx address$local_memory_x
   #+end_src
** ><>< *local-memory-y*
   #+begin_src fasm :tangle cicada-nymph.fasm
   size$local_memory_y = 1024 * 1024 * 6

   address$local_memory_y labeling
      preserve size$local_memory_y

   define_variable "*local-memory-y,current-free-address*", V__local_memory_y__current_free_address
      xx address$local_memory_y
   #+end_src
** *local-memory*
   #+begin_src fasm :tangle cicada-nymph.fasm
