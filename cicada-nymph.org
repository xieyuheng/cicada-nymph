...
* 更多的中文筆記
* add more notes about exception handling
* more syntax for REPLs
  * REPL-key-word
    * jo
* a way to exit REPLs
...
** find-syntax
   ...
   define_function "find-syntax,loop", find_syntax__loop
      ...
      xx xxoverx, xoverxx, fetch
      xx find_rule, false?branch, 7
      xx   swap, drop
      xx   xxswapx, drop2
      xx   true
      xx   end
