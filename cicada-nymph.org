...
** *syntax-set*
   #+begin_src fasm :tangle cicada-nymph.fasm
   define_variable "*syntax-set*", V__syntax_set
      xx address$syntax_set

   define_variable "*current-free-address,syntax-set*", V__current_free_address__syntax_set
      xx address$syntax_set
   #+end_src
** add-syntax                         :64bit:
   #+begin_src fasm :tangle cicada-nymph.fasm
   ...
   define_primitive_function "add-syntax", add_syntax
      ;; << predicate, function -- >>
      pop_argument_stack rax
      mov rbx, [V__current_free_address__syntax_set + jo_size]
      mov [rbx], rax
      add qword [V__current_free_address__syntax_set + jo_size], jo_size
      pop_argument_stack rax
      mov rbx, [V__current_free_address__syntax_set + jo_size]
      mov [rbx], rax
      add qword [V__current_free_address__syntax_set + jo_size], jo_size
...
** add-syntax                         :32bit:
   ...
   define_primitive_function "add-syntax", add_syntax
      ;; << predicate, function -- >>
      pop_argument_stack rax
      mov rsi, [V__current_free_address__syntax_set + jo_size]
      mov [rsi], rax
      add dword [V__current_free_address__syntax_set + jo_size], jo_size
      pop_argument_stack rax
      mov rsi, [V__current_free_address__syntax_set + jo_size]
      mov [rsi], rax
      add dword [V__current_free_address__syntax_set + jo_size], jo_size
...
** clear-syntax-set                   :64bit:
   ...
   define_primitive_function "clear-syntax-set", clear_syntax_set
      ;; << -- >>
      mov qword [V__current_free_address__syntax_set + jo_size], address$syntax_set
      next
...
** clear-syntax-set                   :32bit:
   ...
   define_primitive_function "clear-syntax-set", clear_syntax_set
      ...
      mov dword [V__current_free_address__syntax_set + jo_size], eax;address$syntax_set
      next
...
** find-syntax
   ...
   define_function "find-syntax", find_syntax
      ...
      ;;    -- jo, true
      ;;    -- false >>
      xx V__current_free_address__syntax_set
...
** cursor->syntax
   #+begin_src fasm :tangle cicada-nymph.fasm
   define_function "cursor->syntax", cursor_to_syntax
      ;; << cursor -- syntax[predicate, function] >>
...
** sub-syntax
   ...
   define_function "sub-syntax,loop", sub_syntax__loop
      ...
      xx V__syntax_set, equal?, false?branch, 3
      xx   drop2
      xx   end
      xx literal, cursor$sub_syntax, fetch
      xx cursor_to_syntax
      ;; << predicate, function, predicate, function -- >>
      xx xoverxx, equal?, false?, false?branch, 10
      xx   drop
      xx   V__jo_size
      xx   V__jo_size, addition
      xx   literal, cursor$sub_syntax, sub_save
      xx   taca, sub_syntax__loop
      xx xoverxx, equal?, false?, false?branch, 9
      xx   V__jo_size
      xx   V__jo_size, addition
      xx   literal, cursor$sub_syntax, sub_save
      xx   taca, sub_syntax__loop
   ...
   define_function "sub-syntax,move", sub_syntax__move
      ...
      xx   V__jo_size
      xx   V__jo_size, addition
      xx   address, V__current_free_address__syntax_set
      xx   sub_save
      xx   end
   .more_to_move:
      xx sub_syntax__move_one
      xx taca, sub_syntax__move

   define_function "sub-syntax,move_one", sub_syntax__move_one
